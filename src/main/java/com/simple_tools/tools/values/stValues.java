...
public class stValues {
    ...
    public static int change_block_placer_place_diameter(int block_placer_place_diameter){
        if (block_placer_place_diameter == 15){
            block_placer_place_diameter = 3;
        } else {
    ...
    public static int change_slime_block_place_diameter(int slime_block_place_diameter){
        if (slime_block_place_diameter == 5){
            slime_block_place_diameter = 1;
        } else {
    ...
    public static int change_block_searcher_searching_diameter(int block_searcher_searching_diameter){
        if (block_searcher_searching_diameter == 15)
            block_searcher_searching_diameter = 3;
        else
